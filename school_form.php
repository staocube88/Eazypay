				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							<li><a href="signup.php"><button class="btn btn-success">Sign Up</button></a></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
									<div class="alert alert-info alert-dismissable alert-style-1">
											...
											<i class="zmdi zmdi-info-outline"></i><p> <strong>College Due Payment:</strong> College/Faculty Tab > Select School > Proceed <br>
												<strong>Departmental Due Payment:</strong> Department Tab > Select School > Proceed
											</p> 
										</div>
							...
							<div class="panel panel-default panel-tabs card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Choose Payment Type</h6>
									</div>
