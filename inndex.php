...
<head>
    ...
    <!-- Title -->
    <title>EasyPay NG - Making Payment With Ease </title>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4>Easy to use</h4>
                        <p>Our registration and payment solution allows payement into your account with or without depositors using ATM cards or visiting the bank </p>
                    </div>
                </div>
                <!-- Single Special Area -->
                <div class="col-12 col-md-4">
